    ...
    <section id="training-course" className="py-16 bg-gradient-to-r from-clay to-offwhite dark:from-gray-800 dark:to-gray-900">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-terracotta mb-4 text-shadow-md">دوره آموزشی سفال و سرامیک</h2>
          <p className="text-lg text-foreground/80 max-w-2xl mx-auto font-vazir">
            فراگیری هنر سفال و سرامیک از مبتدی تا پیشرفته با مدرک معتبر فنی و حرفه‌ای
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3">
              <div className="md:col-span-1 h-full relative">
                ...
                <div 
                  ...
                  style={{ backgroundImage: `url(/lovable-uploads/8ef24c56-0e53-4b48-9d5e-bd10447630b2.png)` }}
                >
              ...
              <div className="md:col-span-2">
                <CardContent className="p-6 md:p-8">
                  ...
                  <h3 className="text-2xl font-bold text-terracotta mb-3 text-shadow-sm">
                    دوره جامع آموزش سفال و سرامیک
                  </h3>
                  <p className="text-foreground/80 mb-6 font-vazir">
                    این دوره جامع شامل آموزش تکنیک‌های پیشرفته سفال و سرامیک، لعاب‌کاری و کار با چرخ سفال و سرامیک است که توسط استادان برجسته این هنر ارائه می‌شود. پس از اتمام دوره، مدرک معتبر فنی و حرفه‌ای به شما اعطا خواهد شد.
                  </p>
