...
const Courses = () => {
  ...
  const courseFeatures = [
    "آموزش کامل تکنیک‌های سفال و سرامیک",
    "کار عملی با چرخ سفال و سرامیک",
      ...
      <main className="container-custom py-12 pt-14 sm:pt-16 lg:pt-20">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-terracotta mb-4 animate-fade-in">
            دوره آموزشی سفال و سرامیک ایرولیا
          </h1>
          <p className="text-lg text-foreground/80 max-w-3xl mx-auto">
            از مبتدی تا حرفه‌ای: فراگیری کامل هنر سفال و سرامیک با اساتید مجرب و کسب مدرک معتبر
          </p>
        </div>
