...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "پس از ثبت سفارش، کد رهگیری از طریق پیامک یا ایمیل به شما ارسال می‌شود. همچنین می‌توانید در بخش 'حساب کاربری' وضعیت سفارش‌تان را مشاهده کنید."
    },
    {
      question: "آیا محصولات مناسب استفاده روزانه هستند؟",
      answer: "بله، اکثر محصولات ما علاوه بر زیبایی، کاربردی بوده و برای استفاده روزانه مناسب هستند. در توضیحات هر محصول، نحوه استفاده و نگهداری ذکر شده است."
    },
    {
      question: "چگونه از اصالت محصولات مطمئن شوم؟",
      answer: "تمامی محصولات ما دارای برچسب اصالت و مهر هنرمند سازنده هستند. همچنین گواهی اصالت همراه محصول ارسال می‌شود."
    }
  ];
